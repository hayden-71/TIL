...
-- 고객간 구매 패턴 유사성
-- customers 이너조인 sales 이너조인 customers
-- [손님1, 손님2, 공통구매카테고리수, 공통카테고리이름(GROUP_concat)]
SELECT
	c1.customer_id, c1.customer_name, c2.customer_id, c2.customer_name,
...
-- 2번 손님의 구매 데이터
INNER JOIN customers c2 ON c1.customer_id < c2.customer_id -- 1번 손님과 다른 사람(2번) 고르는 중
